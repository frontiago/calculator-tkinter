...
def equals():
    ...
    try:
        ...
        equation_label.set("Syntaxe error")
        equation_text = ""
...
label = Label(window, textvariable=equation_label, font=("consolas", 12), bg="white", width=24, height=2)
label.pack(pady=15)
...
# clear 
clear = Button(window, text="CC", height=4, width=12, font=35, command=clear)
clear.pack()
